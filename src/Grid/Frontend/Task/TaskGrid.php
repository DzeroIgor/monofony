...
namespace App\Grid\Frontend\Task;
...
final class TaskGrid extends AbstractGrid implements ResourceAwareGridInterface
{
    ...
    public function buildGrid(GridBuilderInterface $gridBuilder): void
    {
        $gridBuilder
            ...
            ->addField(
                TwigField::create('assignee', 'frontend/task/grids/fields/assignee.html.twig')
                    ->setLabel('app.ui.assignee')
            )
            ->addField(
                TwigField::create('timeSlots', 'frontend/task/grids/fields/time_slot.html.twig')
